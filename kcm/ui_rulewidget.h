...
public:
    ...
    void setupUi(QWidget *RuleWidget)
    {
...
#ifndef UI_Q_OS_MAC
        horizontalLayout_3x->setSpacing(-1);
#endif
        ...
        sizePolicy1.setHeightForWidth(simplePort->sizePolicy().hasHeightForWidth());
        simplePort->setSizePolicy(sizePolicy1);
        simplePort->setMinimumSize(QSize(64, 0));
        simplePort->setProperty("showClearButton", QVariant(true));
        ...
        sizePolicy2.setHeightForWidth(advancedSrcHost->sizePolicy().hasHeightForWidth());
        advancedSrcHost->setSizePolicy(sizePolicy2);
        advancedSrcHost->setProperty("showClearButton", QVariant(true));
        ...
        sizePolicy2.setHeightForWidth(advancedSrcPort->sizePolicy().hasHeightForWidth());
        advancedSrcPort->setSizePolicy(sizePolicy2);
        advancedSrcPort->setMinimumSize(QSize(64, 0));
        advancedSrcPort->setProperty("showClearButton", QVariant(true));
        ...
        sizePolicy2.setHeightForWidth(advancedSrcProfile->sizePolicy().hasHeightForWidth());
        advancedSrcProfile->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(advancedDestHost->sizePolicy().hasHeightForWidth());
        advancedDestHost->setSizePolicy(sizePolicy2);
        advancedDestHost->setProperty("showClearButton", QVariant(true));
        ...
        sizePolicy2.setHeightForWidth(advancedDestPort->sizePolicy().hasHeightForWidth());
        advancedDestPort->setSizePolicy(sizePolicy2);
        advancedDestPort->setMinimumSize(QSize(64, 0));
        advancedDestPort->setProperty("showClearButton", QVariant(true));
        ...
        sizePolicy2.setHeightForWidth(advancedDestProfile->sizePolicy().hasHeightForWidth());
        advancedDestProfile->setSizePolicy(sizePolicy2);
        ...
        QWidget::setTabOrder(simplePortRadio, simplePort);
        QWidget::setTabOrder(simplePort, simpleProfileRadio);
        ...
        QWidget::setTabOrder(advancedSrcHostRadio, advancedSrcHost);
        QWidget::setTabOrder(advancedSrcHost, advancedSrcAnyPortRadio);
        QWidget::setTabOrder(advancedSrcAnyPortRadio, advancedSrcPortRadio);
        QWidget::setTabOrder(advancedSrcPortRadio, advancedSrcPort);
        QWidget::setTabOrder(advancedSrcPort, advancedSrcProfileRadio);
        ...
        QWidget::setTabOrder(advancedDestHostRadio, advancedDestHost);
        QWidget::setTabOrder(advancedDestHost, advancedDestAnyPortRadio);
        QWidget::setTabOrder(advancedDestAnyPortRadio, advancedDestPortRadio);
        QWidget::setTabOrder(advancedDestPortRadio, advancedDestPort);
        QWidget::setTabOrder(advancedDestPort, advancedDestProfileRadio);
        ...
        QObject::connect(simplePortRadio, SIGNAL(toggled(bool)), simplePort, SLOT(setEnabled(bool)));
        QObject::connect(simpleProfileRadio, SIGNAL(toggled(bool)), simpleProfile, SLOT(setEnabled(bool)));
        QObject::connect(advancedSrcHostRadio, SIGNAL(toggled(bool)), advancedSrcHost, SLOT(setEnabled(bool)));
        QObject::connect(advancedSrcPortRadio, SIGNAL(toggled(bool)), advancedSrcPort, SLOT(setEnabled(bool)));
        QObject::connect(advancedSrcProfileRadio, SIGNAL(toggled(bool)), advancedSrcProfile, SLOT(setEnabled(bool)));
        QObject::connect(advancedDestHostRadio, SIGNAL(toggled(bool)), advancedDestHost, SLOT(setEnabled(bool)));
        QObject::connect(advancedDestPortRadio, SIGNAL(toggled(bool)), advancedDestPort, SLOT(setEnabled(bool)));
    ...
    void retranslateUi(QWidget *RuleWidget)
    {
        ...
        simplePort->setClickMessage(tr2i18n("Port number", 0));
        ...
        advancedDestHost->setClickMessage(tr2i18n("IP address", 0));
        advancedDestAnyPortRadio->setText(tr2i18n("Any port", 0));
        advancedDestPortRadio->setText(QString());
        advancedDestPort->setClickMessage(tr2i18n("Port number", 0));
